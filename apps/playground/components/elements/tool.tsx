...
export type ToolHeaderProps = {
  ...
  /** Whether the user approved (true) or denied (false) the tool. Only relevant for approval-responded state. */
  approved?: boolean;
...
const getStatusBadge = (status: ToolUIPart["state"], approved?: boolean) => {
  const labels: Record<ToolUIPart["state"], string> = {
    "input-streaming": "Pending",
    "input-available": "Running",
    "approval-requested": "Awaiting Approval",
    "approval-responded": approved === false ? "Denied" : "Approved",
  ...
  const icons: Record<ToolUIPart["state"], ReactNode> = {
    ...
    "approval-responded": approved === false
...
export const ToolOutput = ({
  ...
  return (
    <div className={cn("space-y-2 p-3 sm:p-4", className)} {...props}>
      <h4 className="font-medium text-muted-foreground text-xs uppercase tracking-wide">
